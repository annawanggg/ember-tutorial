...
module('Integration | Component | rental/detailed', function (hooks) {
  ...
  // using beforeEach allows us to share some boilerplate code with each of the test functions, runs once before each test functino executes
  ...
  test('it renders detailed info about a rental property', async function (assert) {
    await render(hbs`<Rental::Detailed @rental={{this.rental}}/>`);
